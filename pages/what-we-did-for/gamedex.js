    ...
    <Layout>
      <div className="wrapper">
        ...
        <p data-aos="fade-up" data-aos-easing="ease-in-out">
          Assets were redrawn, Their complete color palette was revamped and we
          used neon styles (reminiscent of TRON) to create a more digital and
          gamer experience. Most of the assets are floating using
        ...
        <p className="small" data-aos="fade-up" data-aos-easing="ease-in-out">
          Luckily for us, mainly, their brand was already really cool. They had
          brand manuals and everything was well documented. But the brand was
          lacking spirit. We gave this brand a soul by adding interactive
          pieces, fade effects as you scroll (that doesn't take forever
          rendering a blank page that generates a what-am-I-doing-here feeling).
          Darker colors, Neon everywhere, It screams games and cards.
        </p>
        <div
        ...
        <p data-aos="fade-up" data-aos-easing="ease-in-out">
          ...
          experience working with Gamedex, Now that the foundations for a brand
          system is laid out we're starting to work on the product itself to
          develop a solid brand system that is recognizable everywhere.
        </p>
        <figure data-aos="fade-up" data-aos-easing="ease-in-out">
          <img
