    ...
    <Layout>
      <div className="wrapper">
        ...
        <p className="small">
          ...
          the communication layer and below the operating system. They contacted
          us to redesign their website in order to get all the
        ...
        <p data-aos="fade-up" data-aos-easing="ease-in-out">
          ...
          and security, but it's hollow meaning it can be filled with whichever
          content. Given the users the posibility to build anything upon it.
          Meaningful, right?
        </p>
        <figure
          className="smallfigure"
        ...
        <p className="small" data-aos="fade-up" data-aos-easing="ease-in-out">
          ...
          being a descentralized ledgerless protocol made us really squeeze our
          powers of simplification. First we needed to understand the product,
          then we could start working on a brand system that really made sense.
        </p>
        <figure data-aos="fade-up" data-aos-easing="ease-in-out">
          <img
